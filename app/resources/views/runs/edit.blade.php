                    ...
                    <form method="POST" action="{{ route('runs.update', $run->id) }}">
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="run_at" class="block mt-1 w-full" type="datetime-local"
                                          name="run_at" :value="old('run_at', $run->runAt->format('Y-m-d\TH:i'))" required />
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="distance" class="block mt-1 w-full" type="number"
                                          name="distance" :value="old('distance', $run->distance)" required />
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="duration" class="block mt-1 w-full" type="number"
                                          name="duration" :value="old('duration', $run->duration)" required />
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="avg_hr" class="block mt-1 w-full" type="number"
                                          name="avg_hr" :value="old('avg_hr', $run->avgHr)" />
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="cadence" class="block mt-1 w-full" type="number"
                                          name="cadence" :value="old('cadence', $run->cadence)" />
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="rpe" class="block mt-1 w-full" type="number"
                                          name="rpe" :value="old('rpe', $run->rpe)" min="1" max="10" />
                        ...
                        <div class="mb-4">
                            ...
                            <textarea id="notes" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm"
                                      name="notes" rows="3">{{ old('notes', $run->notes) }}</textarea>
